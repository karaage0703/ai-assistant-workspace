...
| **xs-github-repo-analyzer** | 現行HEADとDeepWikiの鮮度を確認して構造・技術スタックを分析 | 「リポジトリ分析して」「このリポジトリ見て」 |
| **xs-xangi-kaizen** | 原因と対策を根拠付きで報告し、明示依頼時だけ修正 | 「調査して」「原因調べて」「なぜなぜ分析」「再発防止」 |
...
| **xs-tech-news-curation** | RSS・記事本文を確認し、要約と注目理由を紹介 | 「テックニュース」「最新のニュース教えて」 |
